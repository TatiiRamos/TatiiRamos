...
- **INFRAX (Security Audit & Frontend):** ver sección arriba.
...
- **Backend & Infra:** Firebase (Auth, Firestore, Cloud Functions), Docker.
- **Seguridad & DevOps:** Análisis OWASP, Hardening Web, Linux, Git / GitHub.
